"""
Django settings for soft_wind_dev_66291 project.
...
ROOT_URLCONF = 'soft_wind_dev_66291.urls'
...
WSGI_APPLICATION = 'soft_wind_dev_66291.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_wind_dev_66291 API",
    "DESCRIPTION": "API documentation for soft_wind_dev_66291 App",
    "VERSION": "v1",
}
